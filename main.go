...
func NewGame() *Game {
	return &Game{
		playerX:   float64(14 * tileSize), // Center of the board
		playerY:   float64(23 * tileSize), // Classic Pac-Man start row
		playerDir: DirNone,
		score:     0,
	}
}

// Update handles game logic each tick (called 60 times per second by default).
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	// Draw a simple yellow square for Pac-Man
